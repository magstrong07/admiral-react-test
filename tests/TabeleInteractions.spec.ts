...
test.describe('table open group', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('http://localhost:3000/#/table_with_group');
  });
...
test.describe('table open group custom', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('http://localhost:3000/#/table_with_group_custom');
  });
...
test.describe('table drag and droup columns', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('http://localhost:3000/#/table_drag_column');
  });
...
test.describe('table virtual scroll', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('http://localhost:3000/#/table_with_percents_scroll');
  });
