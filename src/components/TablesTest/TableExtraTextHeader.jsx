...
import { rowList, columnListExtraText } from './data.tsx';
...
const Tables = (props) => {
  return (
    <>
      <Table {...props} rowList={rowList} columnList={columnListExtraText} />
    </>
  );
};

const TableExtraTextHeader = () => {
...
export default TableExtraTextHeader;
