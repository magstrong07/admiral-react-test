  ...
  return (
    <Table
      ...
      rowBackgroundColorByStatusMap={{
        attention: (color) => color['Attention/Attention 20'],
        warning: (color) => color['Warning/Warning 20'],
      }}
    />
  );
};

const TableWithPercentsAndStatusTest = () => {
...
export default TableWithPercentsAndStatusTest;
