import { SliderRangeField, T } from '@admiral-ds/react-ui';
...
const SliderRangeFields = (props) => {
  return <SliderRangeField {...props} label="введите диапазон" />;
};

const SliderRangeFieldTest = () => {
...
export default SliderRangeFieldTest;
